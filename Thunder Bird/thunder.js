$(document).ready(function() {
  ...
  function totalTimer(){
    ...
    var rugularKiller;
    if(nextWork===0){
      regularKiller = $("<img/>").addClass("regular-killer").css(flyKiller).attr("src","wind.png");;
    }
    else if(nextWork===1){
      regularKiller = $("<img/>").addClass("regular-killer").css(middleKiller).attr("src","wind.png");;
    }
    else{
      regularKiller = $("<img/>").addClass("regular-killer").css(groundKiller).attr("src","wind.png");;
    }
  ...
  function birdTimer(){
    ...
    if(wingsBird===0){
      $("#bird").attr("src","bird1.png");
    }
    else{
      $("#bird").attr("src","bird2.png");
    }
  ...
  function goKiller(){
    ...
    var newKiller = $("<img/>").addClass("special-killer").css(styleKiller).attr("src","wind.png");
